...
HD_PWD='C:/Users/mikke/OneDrive/Skrivebord/Final_project/xadc_with_bram_with_fsm/adc.runs/xadc_pl2ps_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_pl2ps_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xadc_pl2ps_xbar_0.tcl
