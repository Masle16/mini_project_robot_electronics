...
HD_PWD='C:/Users/mathi/OneDrive/Dokumenter/7semester/RobotElectronics/adc/adc.runs/xadc_pl2ps_xadc_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_pl2ps_xadc_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xadc_pl2ps_xadc_wiz_0_0.tcl
