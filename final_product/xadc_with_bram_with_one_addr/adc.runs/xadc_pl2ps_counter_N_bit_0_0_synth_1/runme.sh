...
HD_PWD='C:/Users/An-ck/Desktop/xadc_with_bram_with_one_addr/adc.runs/xadc_pl2ps_counter_N_bit_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_pl2ps_counter_N_bit_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xadc_pl2ps_counter_N_bit_0_0.tcl
