...
HD_PWD='C:/Users/mikke/OneDrive/Skrivebord/xadc_with_bram-workpls/adc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_pl2ps_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xadc_pl2ps_wrapper.tcl
