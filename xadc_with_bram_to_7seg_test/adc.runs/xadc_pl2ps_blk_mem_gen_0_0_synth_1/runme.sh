...
HD_PWD='C:/Users/mikke/OneDrive/Skrivebord/xadc_with_bram/adc.runs/xadc_pl2ps_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_pl2ps_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xadc_pl2ps_blk_mem_gen_0_0.tcl
