...
HD_PWD='C:/Users/mikke/OneDrive/Skrivebord/xadc_with_bram-workpls/adc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_pl2ps_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xadc_pl2ps_wrapper.tcl -notrace
